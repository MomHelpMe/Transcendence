...
export class Default extends Component {
    template () {
	  ...
	  <div id="centerBG">
		<div id="topBG">
			<svg id="topParticle" xmlns="http://www.w3.org/2000/svg" width="140" height="150" viewBox="0 0 140 150" fill="none">
			...
			<svg id="topBall" xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100" fill="none">
				<circle cx="50" cy="50" r="50" fill="#31363F"/>
			</svg>
		</div>
		<div id="bottomBG">
			<svg id="bottomParticle" xmlns="http://www.w3.org/2000/svg" width="140" height="150" viewBox="0 0 140 150" fill="none">
			...
			<svg id="bottomBall" xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100" fill="none">
