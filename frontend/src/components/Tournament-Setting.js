		...
		return `
			<div id="tournament-box">
				...
				<div id="tournament-body">
					...
					<div id="tournament-players">
						<input class="tournament-input" id="tournament-nick1"></input>
						<input class="tournament-input" id="tournament-nick2"></input>
						<div id="tournament-blank"></div>
						<input class="tournament-input" id="tournament-nick3"></input>
						<input class="tournament-input" id="tournament-nick4"></input>
					</div>
				</div>
			</div>
		`;
